...
class Lipreading(nn.Module):
    def __init__(self, mode, inputDim=256, hiddenDim=512, nClasses=10, frameLen=29, every_frame=True):
...
def lipreading(mode, inputDim=256, hiddenDim=512, nClasses=10, frameLen=29, every_frame=True):
